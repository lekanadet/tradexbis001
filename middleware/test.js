...
router.post('/deposittttttt',upload.single('productimage'),(req,res) => { // testing Purpose
  // if (req.userData) { 
...
router.post('/withdrawwww',upload.single('productimage'),(req,res) => { // testing Purpose
  // if (req.userData) { 
